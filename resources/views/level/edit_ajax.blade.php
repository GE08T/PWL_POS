            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group"> 
                        ...
                        <input value="{{ $level->level_kode }}" type="text" class="form-control" id="level_kode" name="level_kode" required>
                        <small id="error-level_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group"> 
                        <label>Level Nama</label> 
                        <input value="{{ $level->level_nama }}" type="text" class="form-control" id="level_nama" name="level_nama" required> 
