            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group"> 
                        ...
                        <input value="{{ $kategori->kategori_kode }}" type="text" class="form-control" id="kategori_kode" name="kategori_kode" required>
                        <small id="error-kategori_kode" class="error-text form-text text-danger"></small>
                    </div> 
                    <div class="form-group"> 
                        <label>Kategori Nama</label> 
                        <input value="{{ $kategori->kategori_nama }}" type="text" class="form-control" id="kategori_nama" name="kategori_nama" required> 
