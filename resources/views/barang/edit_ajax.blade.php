            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group"> 
                        ...
                        <input value="{{ $barang->barang_kode }}" type="text" class="form-control" id="barang_kode" name="barang_kode" required> 
                        <small id="error-barang_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group"> 
                        <label>Nama Barang</label>
                        <input value="{{ $barang->barang_nama }}" type="text" class="form-control" id="barang_nama" name="barang_nama" required>
                    ...
                    <div class="form-group"> 
                        ...
                        <input value="{{ $barang->harga_beli }}" type="number" class="form-control" id="harga_beli" name="harga_beli" required> 
